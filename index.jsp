...
<head>
  ...
  <style>
    ...
    * {
    ...
    .hero .overlay {
      background: linear-gradient(180deg, rgba(26, 35, 126, 0.9), rgba(26, 35, 126, 0.85));
      padding: 40px 20px;
      border-radius: 12px;
      max-width: 980px;
      margin: auto;
    ...
    <div class="flex-row">
      ...
      <div style="flex:1 1 420px;">
         <div style="min-width:200px; text-align:center;">
          <img src="IMG_1650.JPG" alt="Fabric sample" style="width:400px;border-radius:10px; box-shadow:0 6px 18px rgba(0,0,0,0.18)">
        </div>
      </div>
      ...
      <aside class="contact" id="contact">
        ...
        <p style="margin:6px 0">
          ...
          <a href="tel:9931470826">9931470826</a>
        </p>
